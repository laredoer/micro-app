...
func (c *userService) Hello(ctx context.Context, in *go_api.Request, opts ...client.CallOption) (*go_api.Response, error) {
	req := c.c.NewRequest(c.name, "UserService.Hello", in)
...
func (h *userServiceHandler) Hello(ctx context.Context, in *go_api.Request, out *go_api.Response) error {
